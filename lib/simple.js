...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Simple Bot Whatsapp', body: wm, sourceUrl: 'https://chat.whatsapp.com/Jzd9DEVB5nODtNBk1VCNrV', thumbnail: data }}, options })
    }
