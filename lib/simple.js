...
END:VCARD
    ...
    //send3Button
    conn.send3Button = async (jid, content, wm, Button 1, id1, Button 2, id2, Button3, id3, quoted)
const buttons = [
...
const sendMsg = await conn.sendMessage(m.chat, buttonMessage)
    ...
    //hydrate button
    conn.sendHydrate = async (jid, content, distek, link, discall, number, retek, id,quoted) => {
