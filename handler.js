        ...
        if (chat.welcome) {
          ...
          for (let user of participants) {
            ...
            try {
              ...
              this.sendButtonLoc(jid, await(await fetch(pp)).buffer(), text, watermark + `${db.data.chats[jid].deletemedia ? `, delete after ${db.data.chats[jid].deletemediaTime / 1000} s` : ''}`, action === 'add' ? 'Welcome' : 'Goodbye', 'ig :elyas_tzy')
